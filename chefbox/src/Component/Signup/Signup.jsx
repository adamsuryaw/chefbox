                            ...
                            >
                                {formik => 
                                    <div className="field-top">
                                        ...
                                        <UploadImage />
                                        <Form>
                                            <TextBarSignup label="Phone Number" name="phoneNumber" type="text" />
                                            <TextBarSignup label="Address" name="address" type="text" />
                                            <TextBarSignup label="Location (City)" name="location" select="true" type="text"/>
                                            <ButtonSignup />
                                        </Form>
                                    </div>
                                }
