...
import {Button, Box, IconButton, InputBase, Paper, TextField, Typography } from '@mui/material';
                ...
                <div className="input-text">
                    ...
                    <div className="input-select">
                        <div className="input-leftSelect">
                            <h6>Type</h6>
                            <TextBarCreate name="type" select="true" type="text" placeholder="Choose your type"/>
                        </div>
                        <div className="input-rightSelect">
                            <h6>Category</h6>
                            <TextBarCreate name="category" select="true" type="text" placeholder="Choose your type"/>
                        </div>
                    </div>
